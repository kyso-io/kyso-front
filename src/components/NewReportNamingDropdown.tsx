                ...
                <div className="p-4">
                  <div>
                    ...
                    <div className="w-full sm:max-w-xs mt-6 text-right">
                      <Menu.Button
                        type="reset"
                        className="bg-white py-2 px-4 border border-gray-300 hover:bg-gray-100 rounded-md shadow-sm text-sm font-medium text-blue-gray-900 hover:bg-blue-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                        onClick={() => {}}
                      >
                      ...
                      <Menu.Button
                        className={`mt-3 w-full inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm ${
                          newName.length > 0 ? 'bg-kyso-600  hover:bg-kyso-700  focus:ring-indigo-900' : 'text-slate-200	bg-slate-500'
                        }`}
