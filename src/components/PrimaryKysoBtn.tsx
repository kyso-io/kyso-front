...
const PurePrimaryKysoBtn = (props: IPurePrimaryKysoBtn) => {
  ...
  let css = 'shadow-sm text-white bg-kyso-600 hover:bg-kyso-700 focus:ring-primary-hover-ring-color focus:ring-offset-2';
  if (secundary) {
  ...
  if (dangerous) {
    css = 'text-rose-700 bg-white hover:bg-rose-100r';
  }
