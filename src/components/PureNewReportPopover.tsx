    ...
    <React.Fragment>
      <Popover as="div" className="relative inline-block z-[5]">
        {({ open }) => {
          ...
          return (
            <React.Fragment>
              <Popover.Button className="w-fit whitespace-nowrap p-3 font-medium text-white rounded k-bg-primary hover:k-bg-primary-hover text-sm flex flex-row items-center focus:ring-0 focus:outline-none">
                Post a report
