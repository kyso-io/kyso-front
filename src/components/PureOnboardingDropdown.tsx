...
const PureOnboardingDropdown = () => {
  ...
  return (
    <Menu as="div" className="relative">
      <div>
        <Menu.Button
          className="flex max-w-xs items-center text-sml-auto p-1 text-white ver:text-indigo-500/75 focus:outline-none focus:ring-offset-2 focus:ring-offset-kyso-600"
          onClick={() => {
            setOpen(!open);
            setValue('');
          }}
