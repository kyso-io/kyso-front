      ...
      <section aria-labelledby="filter-heading" className="shadow rounded">
        <div
          className={classNames(
            "z-10 bg-white py-2 px-4",
            activeFilters.length > 0 ? "rounded-t border-b" : "rounded"
          )}
        >
          <div className="max-w-7xl mx-auto items-right items-center flex">
                  ...
                  {({ open }) => (
                    <>
                      <div
                        className={classNames(
                          "mt-1 relative",
                          selectedTags.length > 0 || open ? "w-52" : ""
                        )}
                      >
            ...
            <Menu
              as="div"
              className="relative inline-block text-left ml-4 border-l pl-4"
            >
              <div>
