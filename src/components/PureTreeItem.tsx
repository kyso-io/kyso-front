...
import { faFile, faFileCsv, faFileImage, faFilePdf, faFolder, faText } from '@fortawesome/pro-light-svg-icons';
...
const PureTreeItem = (props: IPureTreeItemProps) => {
  const { treeItem, prefix, currentPath } = props;
  ...
  return (
    <>
      <div className="">
        <div>
          <a href={url} className={classNames('p-3 text-xs group flex items-center px-3 font-medium text-gray-600', 'hover:text-gray-900', 'font-normal hover:bg-neutral-50')}>
            {extension === 'ipynb' && (
              <span className="mr-2">
