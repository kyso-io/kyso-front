import type { UserDTO, NormalizedResponseDTO, KysoConfigFile, ReportDTO } from '@kyso-io/kyso-model';
...
const CreateReport = () => {
  ...
  const cleanStorage = () => {
    ...
    removeLocalStorageItem('formAuthors');
  ...
  useEffect(() => {
    ...
    if (getLocalStorageItem('formAuthors')) {
      setSelectedPeople(JSON.parse(getLocalStorageItem('formAuthors')!));
      setHasAnythingCached(true);
    }
  ...
  const setAuthorsDelay = (_newAuthors: string[]) => {
    ...
    setDraftStatus('Saving ...');
    delayedCallback('formAuthors', _newAuthors);
  };
  ...
  if (commonData.team && !hasPermissionCreateReport) {
    ...
    <div>
      <div className="flex flex-row items-center">
        ...
        <div className="w-4/6">
          ...
          <div className="flex flex-row justify-between">
            <div className="flex flex-col">
              <textarea
                ...
                placeholder="Title"
                className="focus:shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full border-white border-0 rounded-md text-3xl font-medium focus:text-gray-500 text-gray-900"
              />
              <textarea
                style={{
                  height: '55px',
                ...
                className="focus:shadow-sm focus:ring-indigo-500 focus:border-indigo-500  block  w-full h-full focus:w-full  border-white border-0 text-gray-500 sm:text-sm rounded-md"
              />
            </div>
            <div className="flex flex-row items-center space-x-2">
              {draftStatus && <h6 className="text-gray-500 text-xs">{draftStatus}</h6>}
              {hasAnythingCached && (
                <button
                  type="reset"
          ...
          <div className="flex flex-row space-x-2 justify-end p-2">
