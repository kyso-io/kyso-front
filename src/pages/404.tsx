      ...
      >
        <div className="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-48">
          ...
          <div className="mt-6">
            <a
              href="#"
              className="inline-flex items-center rounded-md border border-transparent bg-white/75 px-4 py-2 text-sm font-medium text-black/75 sm:bg-white/25 sm:hover:bg-white/50"
            >
              Go back home
            </a>
          </div>
