...
import { CheckIcon, ExclamationCircleIcon, SearchIcon, XIcon } from '@heroicons/react/solid';
              ...
              <React.Fragment>
                ...
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-medium leading-6 text-gray-900 mt-8">
                    Members of {commonData.team?.display_name} ({filteredMembers.length}):
                  </h3>
                ...
                {isOrgAdmin && (
                  <div className="mt-4">
                    <h3 className="text-lg font-medium leading-6 text-gray-900 mt-8 mb-4">Add users to the channel {commonData.team?.display_name}:</h3>
